...
const DOMAINS = [
  {
    ...
    cutoff: 30.72,
    questions: [
      "Ονομάζει τουλάχιστον τρία πράγματα από μια κοινή κατηγορία; Για παράδειγμα, αν πείτε «πες μου μερικά πράγματα που τρώγονται», απαντά με κάτι όπως «μπισκότα, αυγά και δημητριακά»; Ή αν πείτε «πες μου ονόματα ζώων», απαντά με κάτι όπως «αγελάδα, σκύλος και ελέφαντας»;",
  ...
  },
  {
    ...
    questions: [
      ...
      "Με παιδικό ψαλίδι ασφαλείας, κόβει ένα χαρτί στη μέση πάνω σε περίπου ευθεία γραμμή, ανοίγοντας και κλείνοντας τις λεπίδες; Επιβλέπετε προσεκτικά τη χρήση του ψαλιδιού.",
      ...
      "Ζωγραφίζει ανθρώπους που έχουν τουλάχιστον τρία από τα εξής χαρακτηριστικά: κεφάλι, μάτια, μύτη, στόμα, λαιμό, μαλλιά, κορμό, χέρια, παλάμες, πόδια ή πέλματα;",
  ...
  },
  {
    ...
    questions: [
      ...
      "Χωρίς να βοηθήσετε δείχνοντας, ακολουθεί τρεις διαφορετικές οδηγίες με τις λέξεις «κάτω από», «ανάμεσα» και «στη μέση»; Για παράδειγμα, ζητήστε του να βάλει το παπούτσι «κάτω από τον καναπέ», την μπάλα «ανάμεσα στις καρέκλες» και το βιβλίο «στη μέση του τραπεζιού».",
  ...
  },
  {
    ...
    questions: [
      ...
      "Ντύνεται ή γδύνεται χωρίς βοήθεια, εκτός από κόπιτσες, κουμπιά και φερμουάρ;"
    ]
  }
];
...
const QUESTION_IMAGES = {
  "grossMotor-0": {
    src: "assets/48mo-catch-ball.png",
    alt: "Σκίτσο παιδιού που πιάνει μεγάλη μπάλα."
  },
  "grossMotor-2": {
    src: "assets/48mo-throw-overhand.png",
    alt: "Σκίτσο παιδιού που πετά μπάλα πάνω από τον ώμο."
  },
  "grossMotor-3": {
    src: "assets/48mo-hop-one-foot.png",
...
function collectResults() {
  ...
  return {
    questionnaire: "ASQ-3 Ερωτηματολόγιο 48 μηνών",
