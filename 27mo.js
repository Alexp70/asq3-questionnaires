...
const DOMAINS = [
  ...
  },
  {
    ...
    questions: [
      ...
      "Πηδά προς τα εμπρός τουλάχιστον 7-8 εκ. με τα δύο πόδια να σηκώνονται από το έδαφος ταυτόχρονα;",
  ...
  },
  {
    ...
    questions: [
      ...
      "Στοιβάζει μόνο του επτά μικρά τουβλάκια ή παιχνίδια το ένα πάνω στο άλλο; Μπορείτε επίσης να χρησιμοποιήσετε κουβαρίστρες, μικρά κουτιά ή παιχνίδια περίπου 2,5 εκ.",
  ...
  },
  {
    ...
    questions: [
      ...
      "Βάζει πράγματα στη θέση τους εκεί όπου ανήκουν; Για παράδειγμα, ξέρει ότι τα παιχνίδια μπαίνουν στο ράφι, η κουβέρτα στο κρεβάτι και τα πιάτα στην κουζίνα;",
  ...
  },
  {
    ...
    questions: [
      ...
      "Αποκαλεί τον εαυτό του «εγώ» ή «εμένα» πιο συχνά από το όνομά του; Για παράδειγμα, λέει «εγώ κάνω» πιο συχνά από «η Μαρία κάνει»;",
...
function collectResults() {
  ...
  return {
    questionnaire: "ASQ-3 Ερωτηματολόγιο 27 μηνών",
