...
const DOMAINS = [
  {
    ...
    questions: [
      ...
      "Χρησιμοποιεί λέξεις σύγκρισης, όπως «βαρύτερο», «δυνατότερο» ή «κοντύτερο»; Ρωτήστε, για παράδειγμα, «το αυτοκίνητο είναι μεγάλο, αλλά το λεωφορείο είναι ...», «η γάτα είναι βαριά, αλλά ο άνθρωπος είναι ...», «η τηλεόραση είναι μικρή, αλλά το βιβλίο είναι ...».",
      "Απαντά στις παρακάτω ερωτήσεις; Σημειώστε «Μερικές φορές» αν απαντά μόνο στη μία. «Τι κάνεις όταν πεινάς;» και «Τι κάνεις όταν είσαι κουρασμένος/η;»",
      "Επαναλαμβάνει τις παρακάτω προτάσεις χωρίς λάθη; Διαβάστε τις μία-μία. Μπορείτε να επαναλάβετε κάθε πρόταση μία φορά. Σημειώστε «Ναι» αν επαναλάβει και τις δύο χωρίς λάθη και «Μερικές φορές» αν επαναλάβει σωστά μόνο μία: «Η Μαρία έκρυψε τα παπούτσια της για να τα βρει η Άννα.» «Ο Άρης διάβασε το μπλε βιβλίο κάτω από το κρεβάτι του.»"
    ]
  },
  {
    id: "grossMotor",
    ...
    questions: [
      ...
      "Χοροπηδά προς τα εμπρός στο ένα πόδι για απόσταση περίπου 1,2 έως 1,8 μέτρα χωρίς να κατεβάσει το άλλο πόδι; Μπορείτε να του δώσετε δύο προσπάθειες σε κάθε πόδι. Σημειώστε «Μερικές φορές» αν μπορεί να το κάνει μόνο με το ένα πόδι.",
      "Κάνει σκίπινγκ/πηδηχτό περπάτημα χρησιμοποιώντας εναλλάξ τα πόδια; Μπορείτε να του δείξετε πώς να το κάνει."
    ]
  },
  {
    id: "fineMotor",
    ...
    questions: [
      ...
      "Κοιτάζοντας τα σχήματα, τα αντιγράφει στον κενό χώρο χωρίς να τα πατήσει από πάνω; Τα σχέδιά του πρέπει να μοιάζουν με τα σχήματα, ακόμη κι αν έχουν διαφορετικό μέγεθος. Σημειώστε «Ναι» αν αντιγράφει και τα τρία σχήματα και «Μερικές φορές» αν αντιγράφει δύο.",
      "Κοιτάζοντας τα γράμματα V, H, T, C, A, τα αντιγράφει χωρίς να τα πατήσει από πάνω; Καλύψτε όλα τα γράμματα εκτός από αυτό που αντιγράφει. Σημειώστε «Ναι» αν αντιγράφει τέσσερα γράμματα που διαβάζονται και «Μερικές φορές» αν αντιγράφει δύο ή τρία.",
      "Γράψτε το μικρό όνομα του παιδιού. Μπορεί να αντιγράψει τα γράμματα; Τα γράμματα μπορεί να είναι μεγάλα, ανάποδα ή καθρεφτισμένα. Σημειώστε «Μερικές φορές» αν αντιγράφει περίπου τα μισά γράμματα."
    ]
  },
  {
    id: "problemSolving",
    ...
    questions: [
      ...
      "Συμπληρώνει τις παρακάτω προτάσεις με λέξη που σημαίνει το αντίθετο; Για παράδειγμα: «η πέτρα είναι σκληρή και το μαξιλάρι είναι μαλακό». Σημειώστε «Ναι» αν συμπληρώσει σωστά τρεις από τις τέσσερις και «Μερικές φορές» αν συμπληρώσει δύο: «η αγελάδα είναι μεγάλη και το ποντίκι είναι ...», «ο πάγος είναι κρύος και η φωτιά είναι ...», «βλέπουμε αστέρια τη νύχτα και τον ήλιο τη ...», «όταν πετάω την μπάλα πάνω, αυτή έρχεται ...».",
      ...
      "Ονομάζει τουλάχιστον τέσσερα γράμματα από το όνομά του; Δείξτε τα γράμματα και ρωτήστε «Τι γράμμα είναι αυτό;», δείχνοντάς τα με τυχαία σειρά."
    ]
  },
  {
    id: "personalSocial",
    ...
    questions: [
      ...
      "Πλένει τα χέρια και το πρόσωπό του με σαπούνι και νερό και τα σκουπίζει με πετσέτα χωρίς βοήθεια;",
      ...
      "Χρησιμοποιεί την τουαλέτα μόνο του; Πηγαίνει στο μπάνιο, κάθεται στην τουαλέτα, σκουπίζεται και τραβά το καζανάκι. Σημειώστε «Ναι» ακόμη κι αν το κάνει αφού του το υπενθυμίσετε.",
      "Συνήθως περιμένει τη σειρά του και μοιράζεται με άλλα παιδιά;"
    ]
  }
];
...
const QUESTION_IMAGES = {
  "grossMotor-0": {
    src: "assets/60mo-throw-overhand.png",
    alt: "Σκίτσο παιδιού που πετά μπάλα πάνω από τον ώμο."
  },
  "grossMotor-1": {
    src: "assets/60mo-catch-ball.png",
    alt: "Σκίτσο παιδιού που πιάνει μεγάλη μπάλα."
  },
  "grossMotor-2": {
    src: "assets/60mo-hop-one-foot.png",
...
function collectResults() {
  ...
  return {
    questionnaire: "ASQ-3 Ερωτηματολόγιο 60 μηνών",
