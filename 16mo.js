...
const DOMAINS = [
  ...
  },
  {
    ...
    cutoff: 30.51,
    note: "Αν η ερώτηση 5 σημειωθεί «Ναι», η ερώτηση 1 βαθμολογείται ως «Ναι».",
    questions: [
      ...
      "Αφού ρίξετε ένα ψίχουλο ή μικρό δημητριακό σε μικρό, διαφανές μπουκάλι, γυρίζει το μπουκάλι ανάποδα για να το αδειάσει; Μπορείτε να του δείξετε πώς."
    ]
  },
  {
    id: "personalSocial",
...
const QUESTION_IMAGES = {
  "fineMotor-1": {
    src: "assets/16mo-throw-ball.png",
    alt: "Σκίτσο παιδιού που πετά μικρή μπάλα."
  },
  "fineMotor-4": {
    src: "assets/16mo-crayon-mark.png",
    alt: "Σκίτσο χεριού που κάνει σημάδι με κηρομπογιά."
  },
  "problemSolving-3": {
    src: "assets/16mo-tool-reach.png",
...
function collectResults() {
  ...
  return {
    questionnaire: "ASQ-3 Ερωτηματολόγιο 16 μηνών",
