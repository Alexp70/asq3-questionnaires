...
function getDomainScore(domain) {
  ...
  domain.questions.forEach((_, index) => {
    ...
    if (domain.id === "grossMotor" && index === 1) {
...
function collectResults() {
  ...
  return {
    questionnaire: "ASQ-3 Ερωτηματολόγιο 24 μηνών",
