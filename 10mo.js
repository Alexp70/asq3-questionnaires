...
const DOMAINS = [
  ...
  },
  {
    ...
    note: "",
    questions: [
      "Αν το κρατάτε από τα δύο χέρια μόνο για ισορροπία, στηρίζει το βάρος του ενώ στέκεται;",
      "Όταν κάθεται στο πάτωμα, κάθεται ίσια για μερικά λεπτά χωρίς να στηρίζεται με τα χέρια του;",
      "Όταν το στήνετε δίπλα σε έπιπλα ή στο κάγκελο της κούνιας, κρατιέται χωρίς να ακουμπά το στήθος του στα έπιπλα για στήριξη;",
  ...
  },
  {
    ...
    cutoff: 37.97,
    note: "Αν η ερώτηση 5 σημειωθεί «Ναι» ή «Μερικές φορές», η ερώτηση 2 βαθμολογείται ως «Ναι».",
    questions: [
      "Πιάνει το μωρό σας ένα μικρό παιχνίδι χρησιμοποιώντας μόνο το ένα χέρι;",
      "Καταφέρνει το μωρό σας να πιάσει ένα ψίχουλο ή ένα μικρό δημητριακό χρησιμοποιώντας τον αντίχειρα και όλα τα δάχτυλα με κίνηση σαν «τσουγκράνα»; Αν ήδη το πιάνει, σημειώστε «Ναι».",
...
const QUESTION_IMAGES = {
  "grossMotor-0": {
    src: "assets/09mo-standing-support.png",
    alt: "Σκίτσο βρέφους που στέκεται με στήριξη από τα χέρια."
  },
  "grossMotor-1": {
    src: "assets/09mo-sit-straight.png",
    alt: "Σκίτσο βρέφους που κάθεται ίσια."
  },
  "grossMotor-3": {
    src: "assets/09mo-bend-pickup.png",
    alt: "Σκίτσο βρέφους που σκύβει κρατώντας έπιπλο για να πάρει παιχνίδι."
  },
  "grossMotor-5": {
    src: "assets/09mo-cruising-one-hand.png",
    alt: "Σκίτσο βρέφους που περπατά κρατώντας έπιπλο με το ένα χέρι."
  },
  "fineMotor-0": {
    src: "assets/09mo-one-hand-toy.png",
    alt: "Σκίτσο βρέφους που κρατά μικρό παιχνίδι με το ένα χέρι."
  },
  "fineMotor-1": {
    src: "assets/09mo-raking-crumb-success.png",
    alt: "Σκίτσο χεριού που πιάνει μικρό αντικείμενο με κίνηση τσουγκράνας."
  },
  "fineMotor-2": {
    src: "assets/09mo-fingertip-toy.png",
    alt: "Σκίτσο χεριού που πιάνει παιχνίδι με άκρες δαχτύλων."
  },
  "fineMotor-3": {
    src: "assets/09mo-string-pinch.png",
    alt: "Σκίτσο χεριού που πιάνει σπάγκο με δείκτη και αντίχειρα."
  },
  "fineMotor-4": {
    src: "assets/09mo-pincer-crumb.png",
    alt: "Σκίτσο χεριού που πιάνει μικρό αντικείμενο με αντίχειρα και δάχτυλο."
  },
  "fineMotor-5": {
    src: "assets/09mo-set-down-toy.png",
    alt: "Σκίτσο βρέφους που αφήνει παιχνίδι στο τραπέζι."
  },
  "problemSolving-0": {
  ...
  "personalSocial-0": {
    src: "assets/09mo-foot-mouth.png",
...
function getDomainScore(domain) {
  ...
  domain.questions.forEach((_, index) => {
    ...
    if (domain.id === "fineMotor" && index === 1) {
      const item5 = getAnswer("fineMotor-4");
...
function collectResults() {
  ...
  return {
    questionnaire: "ASQ-3 Ερωτηματολόγιο 10 μηνών",
